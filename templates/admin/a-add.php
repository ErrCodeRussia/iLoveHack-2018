        ...
        <div class="col-12 overflow">
            <form action="/admin/add/status/" method="post" id="admin_form">
                ...
                <div class="form-group">
                    ...
                    <input name="hack_name" type="text" class="form-control" id="hack_name" placeholder="Максимум 100 символов" required pattern="[0-9A-Za-z_]{1,100}">
                </div>
                <div class="form-group">
                ...
                <input class="btn btn-outline-warning ml-3" type="reset">Очистить форму</span>
