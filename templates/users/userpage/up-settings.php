<div class="d-flex flex-column data">
    ...
    <form method="POST" class="form form__reg" action="/users/<?= $_SESSION['user_login']; ?>/updatename/">
        <div class="form-group">
            ...
            <input name="user_name" type="text" class="form-control" id="user_name" placeholder="Введите имя" required pattern="[A-Za-z]{1,50}">
        </div>
        <div class="form-group">
            <label for="user_surname">Фамилия: </label>
            <input name="user_surname" type="text" class="form-control" id="user_surname" placeholder="Введите фамилию" required pattern="[A-Za-z]{1,50}">
        </div>
    ...
    <form method="POST" class="form form__reg" action="/users/<?= $_SESSION['user_login']; ?>/updatepass/">
        <div class="form-group">
            ...
            <input name="user_old_pass" type="password" class="form-control" id="user_oldpassword" placeholder="Введите старый пароль" required>
        </div>
        <div class="form-group">
            <label for="user_newpassword">Новый пароль: </label>
            <input name="user_new_pass" type="password" class="form-control" id="user_newpassword" placeholder="Введите новый пароль" required pattern="{6,50}">
        </div>
